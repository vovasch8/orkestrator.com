...
<?php include_once "template/admin-sidebar.php"?>
    ...
    <div id="admin-content" class="container">
        <h5 class="text-center mt-5">Учет времени работы</h5>

        <div class=" row">
            <div class="col-6">
                <select id="dep-select" class="form-select list-select" aria-label="Default select example" name="departament">
                    <?php include_once "template/departaments.php"?>
                </select>
            </div>
            <div class="col-6 text-end">
                <select name="date-select" id="date-select" class="form-select list-select">
